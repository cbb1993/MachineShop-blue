package com.huanhong.mashineshop.utils;
...
public class SharedPreferencesUtils
{
    ...
    private static void init()
    {
        ...
        {
            mSharedPreferences = AppApplication.instance().getSharedPreferences(AppApplication.instance().getPackageName(), Context.MODE_PRIVATE);
        }
    }
